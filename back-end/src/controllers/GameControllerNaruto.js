import GameModelNaruto from '../model/GameModelNaruto.js';
import GameViewNaruto from '../view/GameViewNaruto.js';

class GameControllerNaruto {
  constructor() {
    this.model = new GameModelNaruto();
    this.view = new GameViewNaruto();
    this.firstCard = null;
  ...
  checkEndGame() {
    ...
    if (disabledCards.length === totalPairs * 2 && !this.gameCompleted) {
      ...
      this.saveScore(this.playerName, finalScore, finalTime, 'naruto', this.difficulty);
...
export default GameControllerNaruto;